...
import FieldTableTemplate from 'template/page/create-type-form/field-table';
...
class CreateTypeFormTemplate extends PageTemplate<Input> {
...
export default CreateTypeFormTemplate;
